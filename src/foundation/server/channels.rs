...
fn merge_channels(
    ...
    struct Subs {
        ...
        output: tokio::sync::broadcast::Receiver<crate::foundation::server::OutputEcho>,
        audio: tokio::sync::broadcast::Receiver<crate::foundation::server::AudioEvent>,
        audio_in: tokio::sync::broadcast::Receiver<crate::foundation::server::AudioInEvent>,
        view: tokio::sync::broadcast::Receiver<crate::foundation::server::ViewEvent>,
        vision: tokio::sync::broadcast::Receiver<crate::foundation::server::VideoInEvent>,
    }
